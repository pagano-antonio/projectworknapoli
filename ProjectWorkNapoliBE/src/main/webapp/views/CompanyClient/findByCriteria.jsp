...
<body>
	...
	<div class="wrapper">
		...
		<div id="content">
		<h2>Search Company client</h2>
			<form action="${pageContext.request.contextPath}/CompanyClientCtr/findByCriteria" >
			  ...
			  <input class="btn form-btn" type="submit" value="Search Company client">
			</form>
	</div>
	</div>
