...
<body>
	...
	<div class="wrapper">
		...
		<div id="content">
		<h2>Update Job State Interviw By ID</h2>
			<form action="${pageContext.request.contextPath}/stateJobIntCtr/findById" method="get">
			   <div class="input-100 mb-2">
			  <label class="form-label" for="id">The ID of the job state interview you want to update</label>
			  <input class="form-control" type="number" id="id" name="id" required>
			  </div>
			  <input class="btn form-btn" type="submit" value="Update Job State Interview">
			</form>
	</div>
	</div>
