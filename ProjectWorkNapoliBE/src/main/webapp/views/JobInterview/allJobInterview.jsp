    ...
    <table class="table table-striped table-sm align-middle table-responsive">
        ...
        <tbody>
            <c:forEach var="interview" items="${interviews}">
                <tr>
                    <td class="align-middle">${interview.idJobInterview}</td>
                    <td class="align-middle">${interview.candidate.name} ${interview.candidate.surname}</td>
                    <td class="align-middle">
                       ${interview.date}</td>
                    <td class="align-middle">${interview.stateJobInterview.title}</td>
                    <td class="align-middle">${interview.outcome}</td>
                    <td class="align-middle">${interview.notes}</td>
                    <td class="align-middle">${interview.employee.name} ${interview.employee.surname}</td>
                    
                    <td class="align-middle">
                    <div class="actions">
                     <a href="${pageContext.request.contextPath}/JobInterviewCtr/updateJobInterviewForm?id=${interview.idJobInterview}">
					       <button> 
					 ...
					 <a href="${pageContext.request.contextPath}/JobInterviewCtr/deleteJobInterview?id=${interview.idJobInterview}">
